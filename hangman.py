def welcome():
    ...
    if name.isalpha() == True:
        print(""">> Hi!""",name,"""Glad to have you here! <<<
                You will now be playing against another person. 
                1 person will input the word that the other person will guess.
...
def get_word():
    ...
    print("Please input the word you will need to guess")
    words = input()
    return words.lower()
